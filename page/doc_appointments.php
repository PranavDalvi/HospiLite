...
<body>
    ...
    ?>
    <main>
        <h2>HospiLite - View Appointments</h2>
        <div class="wrapper">
            
            
            <?php
            $results = get_appointments_by_doc_id($pdo, $_SESSION["user_id"]);
            if ($results) {
                foreach ($results as $result) {
                    ...
                    <p>Note: You can click on the patients full name to add prescriptions and further procedures for that particular patient.</p>
                                ...
                                <tr>
                                    ...
                                    <td data-cell="Full Name"> <a class="" href="view_patient_appointment.php?appoId=' . htmlspecialchars($result["id"]) . '">' . htmlspecialchars($result["fullname"])  . '</a></td>
                ...
                echo '<p>Hooray! You have completed all appointments.</p>';
            }
            ?>
